...
public class BoxModel extends BasicModel
{
    ...
    public BoxModel()
    {
        ...
        Hat1 = new ModelRenderer(this, 39, 33);
        Hat1.setTextureSize(128, 128);
        Hat1.addBox(-11F, -1F, -11F, 22, 2, 22);
    ...
    public void render(float scale)
    {
        ...
        Head.rotateAngleY = 0.4181066F;
        Head.rotateAngleZ = 0.2169126F;
